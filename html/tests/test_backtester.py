...
class TestBacktester(unittest.TestCase):
    ...
    def setUp(self):
        self.mock_klines = [
            ...
            {"timestamp": 1678890000000, "open": 102, "high": 108, "low": 101, "close": 106, "volume": 1100},
            {"timestamp": 1678893600000, "open": 106, "high": 110, "low": 104, "close": 108, "volume": 1200},
            {"timestamp": 1678897200000, "open": 108, "high": 112, "low": 107, "close": 111, "volume": 1300},
            {"timestamp": 1678900800000, "open": 111, "high": 115, "low": 109, "close": 113, "volume": 1400},
        ...
        for i in range(6, 250):
            self.mock_klines.append({
                "timestamp": self.mock_klines[-1]["timestamp"] + 3600000, # 1 hour later
    ...
    def test_fetch_historical_klines(self, mock_bybit_session):
        mock_bybit_session.get_kline.return_value = {
            ...
            'result': {
                'list': [
                    [str(k["timestamp"]), str(k["open"]), str(k["high"]), str(k["low"]), str(k["close"]), str(k["volume"])]
