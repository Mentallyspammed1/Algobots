...
from backend_app import app, KlineData
import pytest
import pandas as pd
import numpy as np
...
def test_post_indicators_ema_rsi():
    ...
    mock_klines_data = [
        {"timestamp": 1678886400000, "open": 100.0, "high": 105.0, "low": 98.0, "close": 102.0, "volume": 1000.0},
        {"timestamp": 1678886460000, "open": 102.0, "high": 108.0, "low": 101.0, "close": 106.0, "volume": 1200.0},
        {"timestamp": 1678886520000, "open": 106.0, "high": 107.0, "low": 103.0, "close": 104.0, "volume": 1100.0},
        {"timestamp": 1678886580000, "open": 104.0, "high": 110.0, "low": 103.0, "close": 109.0, "volume": 1500.0},
        {"timestamp": 1678886640000, "open": 109.0, "high": 112.0, "low": 107.0, "close": 111.0, "volume": 1300.0},
        {"timestamp": 1678886700000, "open": 111.0, "high": 115.0, "low": 109.0, "close": 113.0, "volume": 1400.0},
        {"timestamp": 1678886760000, "open": 113.0, "high": 114.0, "low": 110.0, "close": 112.0, "volume": 1000.0},
        {"timestamp": 1678886820000, "open": 112.0, "high": 116.0, "low": 111.0, "close": 115.0, "volume": 1600.0},
        {"timestamp": 1678886880000, "open": 115.0, "high": 118.0, "low": 114.0, "close": 117.0, "volume": 1700.0},
        {"timestamp": 1678886940000, "open": 117.0, "high": 120.0, "low": 116.0, "close": 119.0, "volume": 1800.0},
    ]
...
def test_post_indicators_invalid_kline_data():
    request_payload = {
        "klines": [
            {"timestamp": 1678886400000, "open": 100.0, "high": 105.0, "low": 98.0, "close": 102.0, "volume": "invalid"} # Invalid volume type
        ],
        "ema_period": 3
    }
    response = client.post("/indicators", json=request_payload)
