...
def cancel_specific_order(order_id: str, symbol: str, category: str = 'linear'):
    ...
    try:
        ...
        print(Fore.CYAN + f"  # Sending cancellation request for Order ID: {order_id}, Symbol: {symbol}, Category: {category}..." + Style.RESET_ALL)
        ...
        if response and response['retCode'] == 0:
            print(Fore.GREEN + f"  # Order {order_id} for {symbol} cancelled successfully!" + Style.RESET_ALL)
