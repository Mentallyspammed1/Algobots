...
def place_spot_market_buy(symbol: str = 'BTCUSDT', qty: str = '0.0001'):
    ...
    try:
        ...
        print(Fore.CYAN + f"  # Attempting to place a market buy order for {qty} {symbol}..." + Style.RESET_ALL)
        ...
        if response and response['retCode'] == 0:
            ...
            print(Fore.GREEN + "  # Market buy order placed successfully!" + Style.RESET_ALL)
