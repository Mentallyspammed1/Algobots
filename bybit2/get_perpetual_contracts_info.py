...
def get_perpetual_contracts_info():
    ...
    try:
        ...
        print(Fore.CYAN + "  # Channeling the Bybit API for instrument information (Linear Perpetual)..." + Style.RESET_ALL)
        ...
        if response and response['retCode'] == 0:
            ...
            if instruments:
                print(Fore.GREEN + "  # Successfully retrieved perpetual contract information:" + Style.RESET_ALL)
                for instrument in instruments:
                    symbol = instrument['symbol']
                    status = instrument['status']
                    print(Fore.WHITE + f"    Symbol: {symbol}, Status: {status}" + Style.RESET_ALL)
            else:
                print(Fore.YELLOW + "  # No perpetual contract information found." + Style.RESET_ALL)
        else:
            print(Fore.RED + "  # Failed to retrieve instrument information." + Style.RESET_ALL)
