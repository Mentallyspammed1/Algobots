...
def cancel_all_orders_for_symbol(symbol: str = 'DOGEUSDT', category: str = 'linear'):
    ...
    try:
        ...
        print(Fore.CYAN + f"  # Sending cancellation request for all orders of Symbol: {symbol}, Category: {category}..." + Style.RESET_ALL)
        ...
        if response and response['retCode'] == 0:
            print(Fore.GREEN + f"  # All open orders for {symbol} cancelled successfully!" + Style.RESET_ALL)
        ...
        print(Fore.YELLOW + "  # Ensure your network connection is stable, API keys are valid, and the symbol/category are correct." + Style.RESET_ALL)
