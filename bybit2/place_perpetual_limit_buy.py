...
def place_perpetual_limit_buy(symbol: str = 'ETHUSDT', qty: str = '0.01', price: str = '2000'):
    ...
    try:
        ...
        print(Fore.CYAN + f"  # Attempting to place a limit buy order for {qty} {symbol} at {price}..." + Style.RESET_ALL)
        ...
        if response and response['retCode'] == 0:
            ...
            print(Fore.GREEN + "  # Limit buy order placed successfully!" + Style.RESET_ALL)
