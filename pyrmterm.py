...
def display_indicators(indicators_info, config, market_info, last_price):
    ...
    print_color(f" | Stoch-RSI: {stoch_k_color}{format_decimal(stoch_rsi_k, stoch_rsi_prec)}{Style.RESET_ALL} / {stoch_d_color}{format_decimal(stoch_rsi_d, stoch_rsi_prec)}{Style.RESET_ALL}")
