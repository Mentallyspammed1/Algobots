...
describe('Indicators', () => {
  ...
  describe('calculateATR', () => {
    it('should calculate ATR correctly for a simple series', () => {
      ...
      // TR values:
      // TR[0] = max(10.4-10.0, |10.4-10.2|, |10.0-10.2|) = 0.4
      // TR[1] = max(11.2-10.8, |11.2-10.2|, |10.8-10.2|) = 1.0
      // TR[2] = max(12.1-11.5, |12.1-11.0|, |11.5-11.0|) = 1.1
      // TR[3] = max(13.5-12.8, |13.5-11.8|, |12.8-11.8|) = 1.7
      // TR[4] = max(14.0-13.2, |14.0-13.0|, |13.2-13.0|) = 1.0
      // TRs: [0.4, 1.0, 1.1, 1.7, 1.0]

      // EMA(TR, 3) calculation:
      // SMA(0.4, 1.0, 1.1) = 0.8333
      // EMA[2] = 0.8333
      // EMA[3] = (1.7 - 0.8333) * (2/4) + 0.8333 = 0.43335 + 0.8333 = 1.26665
