...
class BybitIndicators:
    ...
    def _fetch_kline_data(self,
                          ...
                          end_time: int | None = None) -> pd.DataFrame | None:
    ...
    def get_historical_data_with_indicators(self,
                                            ...
                                            indicator_kwargs: dict[str, Any] | None = None) -> pd.DataFrame | None:
    ...
    # Existing Indicators
    def get_sma(self, category: str, symbol: str, interval: str, length: int = 20, **kwargs) -> pd.DataFrame | None:
    ...
    def get_ema(self, category: str, symbol: str, interval: str, length: int = 20, **kwargs) -> pd.DataFrame | None:
        """Calculates Exponential Moving Average (EMA)."""
        return self.get_historical_data_with_indicators(
            category, symbol, interval, indicators=['ema'], indicator_kwargs={'ema': {'length': length, **kwargs}}
        )

    def get_rsi(self, category: str, symbol: str, interval: str, length: int = 14, **kwargs) -> pd.DataFrame | None:
        """Calculates Relative Strength Index (RSI)."""
        return self.get_historical_data_with_indicators(
            category, symbol, interval, indicators=['rsi'], indicator_kwargs={'rsi': {'length': length, **kwargs}}
        )

    def get_macd(self, category: str, symbol: str, interval: str, fast: int = 12, slow: int = 26, signal: int = 9, **kwargs) -> pd.DataFrame | None:
        """Calculates Moving Average Convergence Divergence (MACD)."""
        return self.get_historical_data_with_indicators(
            category, symbol, interval, indicators=['macd'], indicator_kwargs={'macd': {'fast': fast, 'slow': slow, 'signal': signal, **kwargs}}
        )

    def get_bollinger_bands(self, category: str, symbol: str, interval: str, length: int = 20, std: int = 2, **kwargs) -> pd.DataFrame | None:
    ...
    def get_stoch_rsi(self, category: str, symbol: str, interval: str, rsi_length: int = 14, k_length: int = 3, d_length: int = 3, **kwargs) -> pd.DataFrame | None:
    ...
    # --- 10+ New Indicators ---
    def get_supertrend(self, category: str, symbol: str, interval: str, length: int = 7, multiplier: float = 3.0, **kwargs) -> pd.DataFrame | None:
    ...
    def get_atr(self, category: str, symbol: str, interval: str, length: int = 14, **kwargs) -> pd.DataFrame | None:
        """Calculates Average True Range (ATR)."""
        return self.get_historical_data_with_indicators(
            category, symbol, interval, indicators=['atr'], indicator_kwargs={'atr': {'length': length, **kwargs}}
        )

    def get_cci(self, category: str, symbol: str, interval: str, length: int = 20, **kwargs) -> pd.DataFrame | None:
        """Calculates Commodity Channel Index (CCI)."""
        return self.get_historical_data_with_indicators(
            category, symbol, interval, indicators=['cci'], indicator_kwargs={'cci': {'length': length, **kwargs}}
        )

    def get_mfi(self, category: str, symbol: str, interval: str, length: int = 14, **kwargs) -> pd.DataFrame | None:
        """Calculates Money Flow Index (MFI)."""
        return self.get_historical_data_with_indicators(
            category, symbol, interval, indicators=['mfi'], indicator_kwargs={'mfi': {'length': length, **kwargs}}
        )

    def get_obv(self, category: str, symbol: str, interval: str, **kwargs) -> pd.DataFrame | None:
    ...
    def get_stoch(self, category: str, symbol: str, interval: str, k_length: int = 14, d_length: int = 3, smooth_k: int = 3, **kwargs) -> pd.DataFrame | None:
    ...
    def get_ao(self, category: str, symbol: str, interval: str, fast: int = 5, slow: int = 34, **kwargs) -> pd.DataFrame | None:
        """Calculates Awesome Oscillator (AO)."""
        return self.get_historical_data_with_indicators(
            category, symbol, interval, indicators=['ao'], indicator_kwargs={'ao': {'fast': fast, 'slow': slow, **kwargs}}
        )

    def get_psar(self, category: str, symbol: str, interval: str, af0: float = 0.02, af: float = 0.02, max_af: float = 0.2, **kwargs) -> pd.DataFrame | None:
    ...
    def get_vwap(self, category: str, symbol: str, interval: str, **kwargs) -> pd.DataFrame | None:
    ...
    def get_kama(self, category: str, symbol: str, interval: str, length: int = 10, **kwargs) -> pd.DataFrame | None:
