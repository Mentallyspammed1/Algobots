...
class HTTPConnection:
    ...
    def endheaders(self, message_body=None, **kwds):
        ...
        if kwds:
            ...
            raise TypeError(f"endheaders() got an unexpected keyword argument '{kwds.popitem()[0]}'"
                            )
    ...
    def request(self, method, url, body=None, headers={}, **kwds):
        ...
        if kwds:
            # mimic interpreter error for unrecognized keyword
            raise TypeError(f"request() got an unexpected keyword argument '{kwds.popitem()[0]}'"
                            )
