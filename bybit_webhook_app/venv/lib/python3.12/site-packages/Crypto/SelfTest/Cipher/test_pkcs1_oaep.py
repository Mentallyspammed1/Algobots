...
class TestVectorsWycheproof(unittest.TestCase):
    ...
    def load_tests(self, filename):
        ...
        def filter_sha(group):
            if group['sha'] == "SHA-1":
                return SHA1
            if group['sha'] == "SHA-224":
                return SHA224
            if group['sha'] == "SHA-256":
                return SHA256
            if group['sha'] == "SHA-384":
                return SHA384
            if group['sha'] == "SHA-512":
                return SHA512
