...
class HashModule(Protocol):
    @staticmethod
    def new(data: bytes | None) -> Hash: ...


MaskFunction = Callable[[bytes, int, Hash | HashModule], bytes]
...
def new(rsa_key: RsaKey, mgfunc: MaskFunction | None=None, saltLen: int | None=None, randfunc: RndFunction | None=None) -> PSS_SigScheme: ...
