...
try:  # Do we have ssl at all?
    ...
    from ssl import HAS_NEVER_CHECK_COMMON_NAME  # type: ignore[assignment]
    from ssl import OP_NO_COMPRESSION  # type: ignore[assignment]
    from ssl import OP_NO_TICKET  # type: ignore[assignment]
    from ssl import OPENSSL_VERSION  # type: ignore[assignment]
    from ssl import OPENSSL_VERSION_NUMBER  # type: ignore[assignment]
    from ssl import PROTOCOL_TLS  # type: ignore[assignment]
    from ssl import PROTOCOL_TLS_CLIENT  # type: ignore[assignment]
    from ssl import VERIFY_X509_STRICT  # type: ignore[assignment]
    from ssl import OP_NO_SSLv2  # type: ignore[assignment]
    from ssl import OP_NO_SSLv3  # type: ignore[assignment]
    from ssl import SSLContext  # type: ignore[assignment]
    from ssl import TLSVersion  # type: ignore[assignment]
