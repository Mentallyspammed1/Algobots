...
if dns._features.have("doq"):
    ...
    from dns.quic._asyncio import AsyncioQuicConnection
    from dns.quic._asyncio import AsyncioQuicManager
    from dns.quic._asyncio import AsyncioQuicStream
    ...
    from dns.quic._sync import SyncQuicStream
    ...
    if dns._features.have("trio"):
        ...
        from dns.quic._trio import TrioQuicManager  # pylint: disable=ungrouped-imports
        from dns.quic._trio import TrioQuicStream  # pylint: disable=ungrouped-imports
