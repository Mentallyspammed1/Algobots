...
import dns.inet
from dns.quic._common import QUIC_MAX_DATAGRAM
from dns.quic._common import BaseQuicConnection
from dns.quic._common import BaseQuicManager
from dns.quic._common import BaseQuicStream
