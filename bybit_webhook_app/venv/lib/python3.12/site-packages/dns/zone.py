...
from dns.zonetypes import DigestScheme
from dns.zonetypes import _digest_hashers
...
class Zone(dns.transaction.TransactionManager):
    ...
    writable_version_factory: Callable[[], "WritableVersion"] | None = None
    immutable_version_factory: Callable[[], "ImmutableVersion"] | None = None
    ...
    def get_soa(
        ...
        soa: dns.rdataset.Rdataset | None
        if txn:
