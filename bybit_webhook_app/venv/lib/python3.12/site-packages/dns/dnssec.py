...
from dns.exception import DeniedByPolicy  # pylint: disable=W0611
from dns.exception import UnsupportedAlgorithm  # pylint: disable=W0611
from dns.exception import ValidationFailure  # pylint: disable=W0611
...
from dns.rdtypes.ANY.RRSIG import sigtime_to_posixtime
...
if dns._features.have("dnssec"):
    ...
    from dns.dnssecalgs import get_algorithm_cls_from_dnskey  # pylint: disable=C0412
    from dns.dnssecalgs.base import GenericPrivateKey
    from dns.dnssecalgs.base import GenericPublicKey
