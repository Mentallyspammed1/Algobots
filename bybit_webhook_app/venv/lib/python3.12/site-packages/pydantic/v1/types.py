...
from pydantic.v1.validators import constr_strip_whitespace
from pydantic.v1.validators import constr_upper
from pydantic.v1.validators import decimal_validator
from pydantic.v1.validators import float_finite_validator
from pydantic.v1.validators import float_validator
from pydantic.v1.validators import frozenset_validator
from pydantic.v1.validators import int_validator
from pydantic.v1.validators import list_validator
from pydantic.v1.validators import number_multiple_validator
from pydantic.v1.validators import number_size_validator
from pydantic.v1.validators import path_exists_validator
from pydantic.v1.validators import path_validator
from pydantic.v1.validators import set_validator
from pydantic.v1.validators import str_validator
from pydantic.v1.validators import strict_bytes_validator
from pydantic.v1.validators import strict_float_validator
...
def conlist(
    item_type: type[T], *, min_items: int | None = None, max_items: int | None = None, unique_items: bool = None
) -> type[list[T]]:
    # __args__ is needed to conform to typing generics api
    namespace = dict(
