...
from ._abnf import STATUS_NORMAL
from ._abnf import continuous_frame
from ._abnf import frame_buffer
from ._exceptions import WebSocketConnectionClosedException
from ._exceptions import WebSocketProtocolException
from ._handshake import SUPPORTED_REDIRECT_STATUSES
from ._handshake import handshake
from ._http import connect
from ._http import proxy_info
from ._logging import debug
from ._logging import error
from ._logging import isEnabledForError
from ._logging import isEnabledForTrace
from ._logging import trace
from ._socket import getdefaulttimeout
from ._socket import recv
from ._socket import send
from ._socket import sock_opt
...
class WebSocket:
    ...
    def send_bytes(self, data: bytes | bytearray) -> int:
        """
    ...
    def recv_data_frame(self, control_frame: bool = False) -> tuple:
        ...
        while True:
            ...
            if isEnabledForTrace():
                trace(f"++Rcv raw: {frame.format()!r}")
                ...
                try:
                    ...
                    if isEnabledForError():
                        ...
                        if recv_status >= 3000 and recv_status <= 4999:
                            debug(f"close status: {recv_status!r}")
                        elif recv_status != STATUS_NORMAL:
                            error(f"close status: {recv_status!r}")
                    break
                except:
                    break
