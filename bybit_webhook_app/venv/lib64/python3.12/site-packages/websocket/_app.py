...
from ._core import WebSocket
from ._core import getdefaulttimeout
from ._exceptions import WebSocketConnectionClosedException
from ._exceptions import WebSocketException
from ._exceptions import WebSocketTimeoutException
...
class WebSocketApp:
    ...
    def run_forever(
        ...
        def handleDisconnect(
            e: WebSocketConnectionClosedException | ConnectionRefusedError | KeyboardInterrupt | SystemExit | Exception,
