...
if dns._features.have("dnssec"):
    from dns.dnssecalgs.dsa import PrivateDSA
    from dns.dnssecalgs.dsa import PrivateDSANSEC3SHA1
    from dns.dnssecalgs.ecdsa import PrivateECDSAP256SHA256
    from dns.dnssecalgs.ecdsa import PrivateECDSAP384SHA384
    from dns.dnssecalgs.eddsa import PrivateED448
    from dns.dnssecalgs.eddsa import PrivateED25519
    from dns.dnssecalgs.rsa import PrivateRSAMD5
    from dns.dnssecalgs.rsa import PrivateRSASHA1
    from dns.dnssecalgs.rsa import PrivateRSASHA1NSEC3SHA1
    from dns.dnssecalgs.rsa import PrivateRSASHA256
    from dns.dnssecalgs.rsa import PrivateRSASHA512

    _have_cryptography = True
else:
    _have_cryptography = False

AlgorithmPrefix = Optional[bytes | dns.name.Name]
