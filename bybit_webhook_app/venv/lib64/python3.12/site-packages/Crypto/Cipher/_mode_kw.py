...
def W(cipher: ModuleType,
      plaintext: bytes | bytearray) -> bytes:
...
def W_inverse(cipher: ModuleType,
              ciphertext: bytes | bytearray) -> bytes:
...
class KWMode:
    ...
    def seal(self, plaintext: bytes | bytearray) -> bytes:
    ...
    def unseal(self, ciphertext: bytes | bytearray) -> bytes:
