...
from .DH import import_x448_public_key
from .DH import import_x25519_public_key
from .DH import key_agreement
from .KDF import _HKDF_expand
from .KDF import _HKDF_extract
...
class HPKE_Cipher:
    ...
    def _encap(receiver_key: EccKey,
               kem_id: int,
               hashmod: ModuleType,
               sender_key: EccKey | None = None,
               eph_key: EccKey | None = None):
    ...
    def seal(self, plaintext: bytes, auth_data: bytes | None = None):
    ...
    def unseal(self, ciphertext: bytes, auth_data: bytes | None = None):
...
def new(*, receiver_key: EccKey,
        ...
        enc: bytes | None = None,
        sender_key: EccKey | None = None,
        psk: tuple[bytes, bytes] | None = None,
        info: bytes | None = None) -> HPKE_Cipher:
