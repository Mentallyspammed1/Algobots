...
class DssSigScheme:
    def __init__(self, key: DsaKey | EccKey, encoding: str, order: int) -> None: ...
...
def new(key: DsaKey | EccKey, mode: str, encoding: str | None='binary', randfunc: Callable | None=None) -> DeterministicDsaSigScheme | FipsDsaSigScheme | FipsEcDsaSigScheme: ...
