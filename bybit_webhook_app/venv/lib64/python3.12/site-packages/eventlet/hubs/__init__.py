...
__all__ = ["get_default_hub", "get_hub", "trampoline", "use_hub"]
...
def get_default_hub():
    ...
    * select
    ...
    raise HubError(f'no built-in hubs are available: {builtin_hub_modules}')
...
def use_hub(mod=None):
    ...
    if hasattr(mod, 'is_available'):
        if not mod.is_available():
            raise Exception(f'selected hub is not available on this system mod={mod}')
    else:
        msg = f'''Please provide `is_available()` function in your custom Eventlet hub {mod}.
