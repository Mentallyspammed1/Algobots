...
class NeonFormatter(logging.Formatter):
    ...
    FORMATS = {
        logging.DEBUG: NeonColors.CYAN + '%(asctime)s - %(levelname)s - %(name)s - %(funcName)s:%(lineno)d - %(message)s' + NeonColors.RESET,
        logging.INFO: NeonColors.GREEN + '%(asctime)s - %(levelname)s - %(message)s' + NeonColors.RESET,
        logging.WARNING: NeonColors.YELLOW + '%(asctime)s - %(levelname)s - %(message)s' + NeonColors.RESET,
        logging.ERROR: NeonColors.RED + '%(asctime)s - %(levelname)s - %(funcName)s:%(lineno)d - %(message)s' + NeonColors.RESET,
        logging.CRITICAL: NeonColors.BOLD + NeonColors.PINK + '%(asctime)s - %(levelname)s - %(funcName)s:%(lineno)d - %(message)s' + NeonColors.RESET
    }
