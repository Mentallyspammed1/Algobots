...
def display_market_info(
    ...
    try:
        ...
        if pivot_resistance_levels or pivot_support_levels:
            ...
            all_levels = []
            for dct, is_res in ((pivot_resistance_levels, True), (pivot_support_levels, False)):
        ...
        lines.append(f"{COLOR_RED}Error displaying market info. Check logs for details.{COLOR_RESET}")
    finally:
        print("\n".join(lines))
