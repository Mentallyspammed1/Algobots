        ...
        for i, row in enumerate(historical_data):
            ...
            if self.position_size != 0:
                ...
                if unrealized_pnl_pct >= self.profit_take_pct:
                    ...
                    print(f"{timestamp}: Profit-take triggered at {unrealized_pnl_pct:.2%}. Closing position.")
                    should_close = True
                ...
                if should_close:
                    ...
                    self._record_trade(timestamp, side, abs(self.position_size), close_price, fee, pnl)
            ...
            if buy_filled:
                ...
                self._record_trade(timestamp, 'Buy', self.quantity, buy_price, fee, pnl or Decimal('0'))
            ...
            if sell_filled:
                ...
                if pnl:
                    self.current_balance += pnl
                self._record_trade(timestamp, 'Sell', self.quantity, sell_price, fee, pnl or Decimal('0'))
