...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$exports$3e$__ = __turbopack_context__.i("[project]/node_modules/technicalindicators/lib/index.js [app-rsc] (ecmascript) <exports>");
...
function calculateIndicators(closePrices, highPrices, lowPrices, volumes, settings = defaultIndicatorSettings) {
    ...
    // RSI
    const rsiResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$oscillators$2f$RSI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RSI"].calculate({
        values: closePrices,
    ...
    // MACD
    const macdResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$moving_averages$2f$MACD$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MACD"].calculate({
        values: closePrices,
    ...
    // Bollinger Bands
    const bbResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$volatility$2f$BollingerBands$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["BollingerBands"].calculate({
        values: closePrices,
    ...
    // Stochastic
    const stochasticResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$momentum$2f$Stochastic$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Stochastic"].calculate({
        ...input,
    ...
    // ATR
    const atrResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$directionalmovement$2f$ATR$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ATR"].calculate({
        ...input,
    ...
    const obvResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$volume$2f$OBV$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["OBV"].calculate(input));
    const obv = obvResult !== null && !isNaN(obvResult) ? {
        obv: obvResult
    } : null;
    // Williams %R
    const williamsRResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$momentum$2f$WilliamsR$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["WilliamsR"].calculate({
        ...input,
    ...
    // CCI
    const cciResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$oscillators$2f$CCI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["CCI"].calculate({
        ...input,
    ...
    // ROC
    const rocResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$momentum$2f$ROC$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ROC"].calculate({
        values: closePrices,
    ...
    // MFI
    const mfiResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$volume$2f$MFI$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MFI"].calculate({
        ...input,
    ...
    // Awesome Oscillator
    const aoResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$oscillators$2f$AwesomeOscillator$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["AwesomeOscillator"].calculate({
        ...input,
    ...
    // Ichimoku Cloud
    const icResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$ichimoku$2f$IchimokuCloud$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["IchimokuCloud"].calculate({
        high: highPrices,
        low: lowPrices,
    ...
    // SMA
    const smaResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$moving_averages$2f$SMA$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["SMA"].calculate({
        values: closePrices,
    ...
    // Supertrend
    const stFastResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supertrend$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Supertrend"].calculate({
        ...input,
    ...
    const stSlowResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supertrend$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Supertrend"].calculate({
        ...input,
    ...
    // Fisher Transform
    const fisherResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fisher$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["FisherTransform"].calculate({
        ...input,
    ...
    const ehlersResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$exports$3e$__["EhlersInstantaneousTrendline"].calculate({
        values: closePrices,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__67f6e31f._.js.map