...
const generateOrderBook = (startPrice, levels, seed)=>{
    ...
    for(let i = 1; i <= levels; i++){
        const bidPrice = startPrice - i * 0.5;
        const bidSize = random() * 5;
        bidTotal += bidSize;
        bids.push([
            bidPrice,
            bidSize,
        ...
        const askPrice = startPrice + i * 0.5;
        const askSize = random() * 5;
        askTotal += askSize;
        asks.push([
            askPrice,
            askSize,
...
const generateRecentTrades = (startPrice, count, seed)=>{
    const random = seededRandom(seed);
    const trades = [];
    let lastPrice = startPrice;
    const now = new Date(2024, 6, 22, 10, 0, 0); // Use a fixed time to avoid hydration issues
    for(let i = 0; i < count; i++){
        const side = random() > 0.5 ? 'buy' : 'sell';
        const price = lastPrice + (random() - 0.5) * 2;
        const amount = random() * 2;
        const time = new Date(now.getTime() - i * 1000 * (random() * 5 + 1));
        trades.push({
...
const getMarketData = (symbol)=>{
    ...
    const random = seededRandom(seed);
    const basePrice = symbol.startsWith('BTC') ? 68000 : symbol.startsWith('ETH') ? 3600 : 150;
    const high = basePrice * 1.05;
    const low = basePrice * 0.95;
    const volume = random() * 10000;
    return {
        high: high.toFixed(2),
        low: low.toFixed(2),
...
const getOrderBookData = (symbol)=>{
    const seed = getSeed(symbol);
    const basePrice = symbol.startsWith('BTC') ? 68000 : symbol.startsWith('ETH') ? 3600 : 150;
    return generateOrderBook(basePrice, 15, seed);
};
const getRecentTradesData = (symbol)=>{
    const seed = getSeed(symbol);
    const basePrice = symbol.startsWith('BTC') ? 68000 : symbol.startsWith('ETH') ? 3600 : 150;
    return generateRecentTrades(basePrice, 20, seed);
};
}}),
...
function MarketData({ symbol }) {
    const data = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMarketData"])(symbol);
...
function OrderBook({ symbol }) {
    const { bids, asks } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getOrderBookData"])(symbol);
    const renderRows = (data, type)=>{
        const sortedData = type === 'ask' ? data.slice().reverse() : data;
        const maxTotal = data.length > 0 ? data.reduce((max, current)=>Math.max(max, current[2]), 0) : 0;
        return sortedData.map(([price, size, total], index)=>{
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getOrderBookData"])(symbol).bids[0][0].toFixed(2)
                            }, void 0, false, {
                                fileName: "[project]/src/components/dashboard/order-book.tsx",
                                lineNumber: 55,
                                columnNumber: 13
...
function RecentTrades({ symbol }) {
    const trades = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getRecentTradesData"])(symbol);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardHeader"], {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardTitle"], {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableBody"], {
                                children: trades.map((trade, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableRow"], {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableCell"], {
                                                className: "p-2 text-right",
                                                children: trade.amount.toFixed(3)
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/dashboard/recent-trades.tsx",
                                                lineNumber: 35,
                                                columnNumber: 19
...
"[project]/src/lib/data:2b40df [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
;
var getAiTradingSignal = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$client$2d$wrapper$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createServerReference"])("60c6125dbbad3595350503c517b30b35b439281e36", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$client$2d$wrapper$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["callServer"], void 0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$client$2d$wrapper$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["findSourceMapURL"], "getAiTradingSignal"); //# sourceMappingURL=data:application/json;base64,
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$2b40df__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:2b40df [app-ssr] (ecmascript) <text/javascript>");
...
function AiSignal({ symbol, timeframe }) {
    ...
    const handleGenerateSignal = async ()=>{
        setIsLoading(true);
        setAnalysis('');
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$2b40df__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getAiTradingSignal"])(symbol, timeframe);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d8a5ab88._.js.map