...
const SupertrendResultSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["z"].object({
    direction: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["z"].number(),
    ...
    up: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["z"].number(),
    down: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["z"].number()
}).nullable();
...
function calculateIndicators(closePrices, highPrices, lowPrices, volumes, settings = defaultIndicatorSettings) {
    ...
    // RSI
    const rsi = createIndicatorResult(safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$oscillators$2f$RSI$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RSI"].calculate({
        values: closePrices,
    ...
    // MACD
    const macd = createIndicatorResult(safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$moving_averages$2f$MACD$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MACD"].calculate({
        values: closePrices,
    ...
    // Bollinger Bands
    const bollingerBands = createIndicatorResult(safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$volatility$2f$BollingerBands$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BollingerBands"].calculate({
        values: closePrices,
        period: settings.bollingerBands.period,
        stdDev: settings.bollingerBands.stdDev
    })), (res)=>res);
    // Stochastic
    const stochastic = createIndicatorResult(safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$momentum$2f$Stochastic$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Stochastic"].calculate({
        ...input,
        period: settings.stochastic.period,
        signalPeriod: settings.stochastic.slowing
    })), (res)=>res);
    // ATR
    const atr = createIndicatorResult(safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$directionalmovement$2f$ATR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ATR"].calculate({
        ...input,
    ...
    const obv = createIndicatorResult(safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$volume$2f$OBV$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["OBV"].calculate(input)), (res)=>({
            obv: res
        }));
    // Williams %R
    const williamsR = createIndicatorResult(safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$momentum$2f$WilliamsR$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WilliamsR"].calculate({
        ...input,
    ...
    // CCI
    const cci = createIndicatorResult(safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$oscillators$2f$CCI$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CCI"].calculate({
        ...input,
    ...
    // ROC
    const roc = createIndicatorResult(safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$momentum$2f$ROC$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROC"].calculate({
        values: closePrices,
    ...
    // MFI
    const mfi = createIndicatorResult(safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$volume$2f$MFI$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MFI"].calculate({
        ...input,
    ...
    // Awesome Oscillator
    const awesomeOscillator = createIndicatorResult(safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$oscillators$2f$AwesomeOscillator$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AwesomeOscillator"].calculate({
        ...input,
    ...
    // Ichimoku Cloud
    const ichimokuCloud = createIndicatorResult(safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$ichimoku$2f$IchimokuCloud$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["IchimokuCloud"].calculate({
        high: highPrices,
        low: lowPrices,
    ...
    // SMA
    const sma = createIndicatorResult(safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$moving_averages$2f$SMA$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SMA"].calculate({
        values: closePrices,
    ...
    // Supertrend
    const supertrendFast = createIndicatorResult(safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supertrend$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Supertrend"].calculate({
        ...input,
        period: settings.supertrendFast.atrPeriod,
        multiplier: settings.supertrendFast.multiplier
    })), (res)=>res);
    const supertrendSlow = createIndicatorResult(safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supertrend$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Supertrend"].calculate({
        ...input,
        period: settings.supertrendSlow.atrPeriod,
        multiplier: settings.supertrendSlow.multiplier
    })), (res)=>res);
    // Fisher Transform
    const fisher = createIndicatorResult(safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fisher$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FisherTransform"].calculate({
        ...input,
        period: settings.fisher.period
    })), (res)=>res);
    // Ehlers Instantaneous Trendline
    const ehlers = createIndicatorResult(safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$exports$3e$__["EhlersInstantaneousTrendline"].calculate({
        values: closePrices
    })), (res)=>({
            trendline: res
        }));
...
//# sourceMappingURL=src_e43debf8._.js.map