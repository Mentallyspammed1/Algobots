...
"[project]/src/lib/supertrend.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$directionalmovement$2f$ATR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/technicalindicators/lib/directionalmovement/ATR.js [app-client] (ecmascript)");
;
;
class SupertrendInput extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$indicator$2f$indicator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IndicatorInput"] {
    multiplier;
    period;
    high;
    low;
...
class Supertrend extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$indicator$2f$indicator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Indicator"] {
    result;
    generator;
    constructor(input){
        super(input);
        const atr = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$directionalmovement$2f$ATR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATR"]({
            high: [],
            low: [],
            close: [],
            period: input.period
        ...
        this.generator = function*() {
            let currentTick = yield;
            let lastResult;
            let atrValue;
            while(true){
                atrValue = atr.nextValue({
                ...
                const up = (currentTick.high + currentTick.low) / 2 - input.multiplier * atrValue;
                const down = (currentTick.high + currentTick.low) / 2 + input.multiplier * atrValue;
                const result = {
                    up: up,
                    down: down,
                    direction: 1,
                ...
                if (lastResult === undefined) {
                    result.value = result.up;
                    currentTick = yield result;
                    lastResult = result;
                    continue;
                }
                result.up = lastResult.up;
                result.down = lastResult.down;
                result.direction = lastResult.direction;
                if (lastResult.value === lastResult.up && currentTick.close < lastResult.up) {
                    result.direction = -1;
                    result.value = down;
                } else if (lastResult.value === lastResult.down && currentTick.close > lastResult.down) {
                    result.direction = 1;
                    result.value = up;
                } else if (result.direction === 1) {
                    result.value = Math.max(up, lastResult.up);
                } else {
                    result.value = Math.min(down, lastResult.down);
                }
                if (result.direction === 1) {
                    result.up = result.value;
                } else {
                    result.down = result.value;
                }
                lastResult = result;
                currentTick = yield result;
            }
        ...
        input.low.forEach((tick, index)=>{
            ...
            if (result) this.result.push(result);
        });
    }
    ...
    nextValue(tick) {
        return this.generator.next(tick).value;
    }
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
...
"[project]/src/lib/fisher.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$indicator$2f$indicator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/technicalindicators/lib/indicator/indicator.js [app-client] (ecmascript)");
;
class FisherTransformInput extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$indicator$2f$indicator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IndicatorInput"] {
    period;
    high;
    low;
}
...
class FisherTransform extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$indicator$2f$indicator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Indicator"] {
    result;
    generator;
    constructor(input){
        super(input);
        ...
        this.generator = function*() {
            ...
            tick = yield;
            while(true){
                price.push((tick.high + tick.low) / 2);
                if (price.length > period) {
                    price.shift();
                }
                highest.push(tick.high);
                if (highest.length > period) {
                    highest.shift();
                }
                lowest.push(tick.low);
                if (lowest.length > period) {
                    lowest.shift();
                }
                let max = Math.max(...highest);
                let min = Math.min(...lowest);
                let value = 0.33 * 2 * ((price[price.length - 1] - min) / (max - min) - 0.5);
                if (values.length > 0) {
                    value = value + 0.67 * values[values.length - 1];
                }
                ...
                if (fishers.length > 0) {
                    fisher = fisher + 0.5 * fishers[fishers.length - 1].fisher;
                }
                let trigger = fishers.length > 0 ? fishers[fishers.length - 1].fisher : 0;
                let result = {
                    fisher,
                    trigger
                };
                fishers.push(result);
                if (fishers.length > period) {
                    fishers.shift();
                }
                tick = yield result;
            }
        ...
        input.high.forEach((tickHigh, index)=>{
            ...
            let result = this.generator.next(tickInput).value;
            if (result) {
    ...
    static calculate = (input)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$indicator$2f$indicator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Indicator"].reverseInputs(input);
        let result = new FisherTransform(input).result;
        if (input.reversedInput) {
            result.reverse();
        }
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$indicator$2f$indicator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Indicator"].reverseInputs(input);
    ...
    nextValue(tick) {
        let result = this.generator.next(tick).value;
        return result;
    }
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$momentum$2f$Stochastic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/technicalindicators/lib/momentum/Stochastic.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$directionalmovement$2f$ATR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/technicalindicators/lib/directionalmovement/ATR.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$volume$2f$OBV$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/technicalindicators/lib/volume/OBV.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$momentum$2f$WilliamsR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/technicalindicators/lib/momentum/WilliamsR.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$oscillators$2f$CCI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/technicalindicators/lib/oscillators/CCI.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$momentum$2f$ROC$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/technicalindicators/lib/momentum/ROC.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$volume$2f$MFI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/technicalindicators/lib/volume/MFI.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$oscillators$2f$AwesomeOscillator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/technicalindicators/lib/oscillators/AwesomeOscillator.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$ichimoku$2f$IchimokuCloud$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/technicalindicators/lib/ichimoku/IchimokuCloud.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__ = __turbopack_context__.i("[project]/node_modules/technicalindicators/lib/index.js [app-client] (ecmascript) <exports>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supertrend$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supertrend.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fisher$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fisher.ts [app-client] (ecmascript)");
;
;
;
;
...
const RsiResultSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    rsi: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number().nullable()
}).nullable();
const MacdResultSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    macd: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number().nullable(),
    signal: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number().nullable(),
    histogram: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number().nullable()
}).nullable();
...
const StochasticResultSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    k: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number().nullable(),
    d: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number().nullable()
}).nullable();
const AtrResultSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    atr: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number().nullable()
}).nullable();
const ObvResultSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    obv: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number().nullable()
}).nullable();
const WilliamsRResultSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    williamsR: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number().nullable()
}).nullable();
const CciResultSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    cci: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number().nullable()
}).nullable();
const RocResultSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    roc: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number().nullable()
}).nullable();
const MfiResultSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    mfi: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number().nullable()
}).nullable();
const AwesomeOscillatorResultSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    ao: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number().nullable()
}).nullable();
const IchimokuCloudResultSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    tenkanSen: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number(),
    kijunSen: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number(),
    senkouSpanA: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number(),
    senkouSpanB: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number()
}).nullable();
const SmaResultSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    sma: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number().nullable()
}).nullable();
...
const FisherTransformResultSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    fisher: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number().nullable(),
    trigger: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number().nullable()
}).nullable();
const EhlersTrendlineResultSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    trendline: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number().nullable()
}).nullable();
...
function calculateIndicators(closePrices, highPrices, lowPrices, volumes, settings = defaultIndicatorSettings) {
    ...
    // RSI
    const rsiResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$oscillators$2f$RSI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RSI"].calculate({
        values: closePrices,
        period: settings.rsi.period
    }));
    const rsi = rsiResult !== null && !isNaN(rsiResult) ? {
        rsi: rsiResult
    } : null;
    // MACD
    const macdResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$moving_averages$2f$MACD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MACD"].calculate({
        values: closePrices,
    ...
    // Bollinger Bands
    const bbResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$volatility$2f$BollingerBands$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BollingerBands"].calculate({
        values: closePrices,
    ...
    // Stochastic
    const stochasticResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$momentum$2f$Stochastic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Stochastic"].calculate({
        ...input,
    ...
    // ATR
    const atrResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$directionalmovement$2f$ATR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATR"].calculate({
        ...input,
        period: settings.atr.period
    }));
    const atr = atrResult !== null && !isNaN(atrResult) ? {
        atr: atrResult
    } : null;
    // OBV (On-Balance Volume)
    const obvResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$volume$2f$OBV$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OBV"].calculate(input));
    const obv = obvResult !== null && !isNaN(obvResult) ? {
        obv: obvResult
    } : null;
    // Williams %R
    const williamsRResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$momentum$2f$WilliamsR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WilliamsR"].calculate({
        ...input,
        period: settings.williamsR.period
    }));
    const williamsR = williamsRResult !== null && !isNaN(williamsRResult) ? {
        williamsR: williamsRResult
    } : null;
    // CCI
    const cciResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$oscillators$2f$CCI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CCI"].calculate({
        ...input,
        period: settings.cci.period
    }));
    const cci = cciResult !== null && !isNaN(cciResult) ? {
        cci: cciResult
    } : null;
    // ROC
    const rocResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$momentum$2f$ROC$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ROC"].calculate({
        values: closePrices,
        period: settings.roc.period
    }));
    const roc = rocResult !== null && !isNaN(rocResult) ? {
        roc: rocResult
    } : null;
    // MFI
    const mfiResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$volume$2f$MFI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MFI"].calculate({
        ...input,
        period: settings.mfi.period
    }));
    const mfi = mfiResult !== null && !isNaN(mfiResult) ? {
        mfi: mfiResult
    } : null;
    // Awesome Oscillator
    const aoResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$oscillators$2f$AwesomeOscillator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AwesomeOscillator"].calculate({
        ...input,
        fastPeriod: settings.awesomeOscillator.fast,
        slowPeriod: settings.awesomeOscillator.slow,
        format: (a)=>a
    }));
    const awesomeOscillator = aoResult !== null && !isNaN(aoResult) ? {
        ao: aoResult
    } : null;
    // Ichimoku Cloud
    const icResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$ichimoku$2f$IchimokuCloud$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IchimokuCloud"].calculate({
        high: highPrices,
        low: lowPrices,
        ...
        displacement: settings.ichimokuCloud.senkou // In library, displacement is same as span B
    }));
    const ichimokuCloud = icResult ? {
        tenkanSen: icResult.conversion,
        kijunSen: icResult.base,
        senkouSpanA: icResult.spanA,
        senkouSpanB: icResult.spanB
    } : null;
    // SMA
    const smaResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$moving_averages$2f$SMA$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SMA"].calculate({
        values: closePrices,
        period: settings.sma.period
    }));
    const sma = smaResult !== null && !isNaN(smaResult) ? {
        sma: smaResult
    } : null;
    // Supertrend
    const stFastResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supertrend$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Supertrend"].calculate({
        ...input,
        period: settings.supertrendFast.atrPeriod,
        multiplier: settings.supertrendFast.multiplier
    }));
    const supertrendFast = stFastResult ? {
        direction: stFastResult.direction > 0 ? 'buy' : 'sell',
        supertrend: stFastResult.value
    } : null;
    const stSlowResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supertrend$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Supertrend"].calculate({
        ...input,
        period: settings.supertrendSlow.atrPeriod,
        multiplier: settings.supertrendSlow.multiplier
    }));
    const supertrendSlow = stSlowResult ? {
        direction: stSlowResult.direction > 0 ? 'buy' : 'sell',
        supertrend: stSlowResult.value
    } : null;
    // Fisher Transform
    const fisherResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fisher$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FisherTransform"].calculate({
        ...input,
        period: settings.fisher.period
    }));
    const fisher = fisherResult ? {
        fisher: fisherResult.fisher,
        trigger: fisherResult.trigger
    } : null;
    // Ehlers Instantaneous Trendline
    const ehlersResult = safeLast(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$technicalindicators$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["EhlersInstantaneousTrendline"].calculate({
        values: closePrices,
        period: settings.ehlers.period
    }));
    const ehlers = ehlersResult !== null && !isNaN(ehlersResult) ? {
        trendline: ehlersResult
    } : null;
    return {
        rsi,
        macd,
...
//# sourceMappingURL=src_d6e4bc2a._.js.map