...
"[project]/src/lib/data:53dd65 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$chart$2d$no$2d$axes$2d$column$2d$increasing$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__BarChart$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/chart-no-axes-column-increasing.js [app-client] (ecmascript) <export default as BarChart>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$53dd65__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:53dd65 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/skeleton.tsx [app-client] (ecmascript)");
...
function AiSignal({ symbol, timeframe, indicatorSettings }) {
    ...
    const handleGenerateSignal = async ()=>{
        setIsLoading(true);
        setAnalysis(null);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$53dd65__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getAiTradingSignal"])(symbol, timeframe, indicatorSettings);
...
"[project]/src/lib/data:0180c7 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
class ATR extends Indicator {
    ...
    calculate() {
        ...
        for(let i = 1; i < this.data.length; i++){
            const highLow = this.data[i].high - this.data[i].low;
            const highPrevClose = Math.abs(this.data[i].high - this.data[i - 1].close);
            const lowPrevClose = Math.abs(this.data[i].low - this.data[i - 1].close);
            trs.push(Math.max(highLow, highPrevClose, lowPrevClose));
        }
        const atrs = new Array(this.period - 1).fill(null);
        let sum = trs.slice(0, this.period).reduce((a, b)=>a + b, 0);
        let prevAtr = sum / this.period;
        atrs.push(prevAtr);
        for(let i = this.period; i < trs.length; i++){
            const atr = (prevAtr * (this.period - 1) + trs[i]) / this.period;
            atrs.push(atr);
            prevAtr = atr;
        }
        return atrs;
...
class Supertrend extends Indicator {
    ...
    calculate() {
        ...
        for(let i = 0; i < this.data.length; i++){
            ...
            const newUpperBand = (high + low) / 2 + this.multiplier * atr;
            const newLowerBand = (high + low) / 2 - this.multiplier * atr;
            if (i === 0) {
                supertrend = newLowerBand;
            }
            const prevClose = i > 0 ? this.data[i - 1].close : close;
            const prevSupertrend = i > 0 && results[i - 1] ? results[i - 1].supertrend : 0;
            const prevDirection = i > 0 && results[i - 1] ? results[i - 1].direction : 'buy';
...
function calculateIndicators(data, settings) {
    ...
    const createIndicatorResult = (indicator)=>{
    ...
    const supertrendFast = createIndicatorResult(new Supertrend(data, settings.supertrendFast.atrPeriod, settings.supertrendFast.multiplier));
    const supertrendSlow = createIndicatorResult(new Supertrend(data, settings.supertrendSlow.atrPeriod, settings.supertrendSlow.multiplier));
    const chandelier = createIndicatorResult(new ChandelierExit(data, settings.chandelier.period, settings.chandelier.multiplier));
    // Placeholder for other indicators until they are converted to the class-based system
    return {
        supertrendFast,
        supertrendSlow,
        chandelier
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/card.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/skeleton.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$0180c7__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:0180c7 [app-client] (ecmascript) <text/javascript>");
        ...
        "IndicatorSuite.useEffect": ()=>{
            const fetchData = {
                "IndicatorSuite.useEffect.fetchData": async ()=>{
                    setIsLoading(true);
                    const indicatorData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$0180c7__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getIndicatorData"])(symbol, timeframe, settings);
...
//# sourceMappingURL=src_f98e02da._.js.map