...
(()=>{
    const e = new Error("Cannot find module 'technicalindicators/lib/trend/EhlersInstantaneousTrendline'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module 'technicalindicators/lib/oscillators/FisherTransform'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
function calculateIndicators(closePrices, highPrices, lowPrices, volumes, settings = defaultIndicatorSettings) {
    ...
    // Fisher Transform
    const fisherResult = safeLast(FisherTransform.calculate({
        ...input,
    ...
    const ehlersResult = safeLast(EhlersInstantaneousTrendline.calculate({
        values: closePrices,
...
//# sourceMappingURL=src_ed552e7a._.js.map