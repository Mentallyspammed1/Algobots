...
function MarketData({ symbol }) {
    ...
    const [wsStatus, setWsStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('connecting');
    ...
    const retryCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    const connectWebSocket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MarketData.useCallback[connectWebSocket]": ()=>{
            if (wsRef.current) {
                wsRef.current.close();
            }
            setWsStatus(retryCount.current > 0 ? 'reconnecting' : 'connecting');
            wsRef.current = new WebSocket(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$bybit$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BYBIT_WEBSOCKET_URL"]);
            ...
            wsRef.current.onmessage = ({
                "MarketData.useCallback[connectWebSocket]": (event)=>{
                    const message = JSON.parse(event.data);
                    if (message.topic === `tickers.${symbol}` && message.data) {
                        setData({
                            "MarketData.useCallback[connectWebSocket]": (prevData)=>{
                                const newData = {
                                    ...prevData,
                                    ...message.data
                                };
            ...
            wsRef.current.onerror = ({
                "MarketData.useCallback[connectWebSocket]": (err)=>{
...
_s(MarketData, "SPk138ri8IVV2hDmvC2XacJw70A=");
_c = MarketData;
var _c;
...
function OrderBook({ symbol, className }) {
    ...
    const connect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OrderBook.useCallback[connect]": ()=>{
            if (wsRef.current) wsRef.current.close();
            setWsStatus(retryCount.current > 0 ? 'reconnecting' : 'connecting');
            const ws = new WebSocket(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$bybit$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BYBIT_WEBSOCKET_URL"]);
            wsRef.current = ws;
            ws.onopen = ({
                "OrderBook.useCallback[connect]": ()=>{
            ...
            ws.onmessage = ({
                "OrderBook.useCallback[connect]": (event)=>{
                    ...
                    if (data.topic?.startsWith('orderbook')) {
                        ...
                        if (type === 'snapshot') {
                            ...
                            const update = {
                                "OrderBook.useCallback[connect].update": (current, delta)=>{
                                    const newMap = new Map(current);
                                    delta.forEach({
                                        "OrderBook.useCallback[connect].update": ([price, size])=>{
                                            if (size === '0') {
                                                newMap.delete(price);
                                            } else {
                                    ...
                                    }["OrderBook.useCallback[connect].update"]);
                                    return Array.from(newMap.entries());
                                }
                            }["OrderBook.useCallback[connect].update"];
                            setBids({
                                "OrderBook.useCallback[connect]": (prev)=>update(prev, orderData.b).sort({
                                        "OrderBook.useCallback[connect]": (a, b)=>parseFloat(b[0]) - parseFloat(a[0])
                                    }["OrderBook.useCallback[connect]"])
                            }["OrderBook.useCallback[connect]"]);
                            setAsks({
                                "OrderBook.useCallback[connect]": (prev)=>update(prev, orderData.a).sort({
                                        "OrderBook.useCallback[connect]": (a, b)=>parseFloat(a[0]) - parseFloat(b[0])
                                    }["OrderBook.useCallback[connect]"])
                            }["OrderBook.useCallback[connect]"]);
                        }
                        ...
                        setLastPrice({
                            "OrderBook.useCallback[connect]": (prev)=>{
                                if (prev && newPrice) {
            ...
            ws.onerror = ({
                "OrderBook.useCallback[connect]": (err)=>{
...
_s(OrderBook, "mf3nxx4dQDuHwd9ChrrUbewGW+U=");
_c = OrderBook;
var _c;
...
"[project]/src/lib/data:ce063b [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$scroll$2d$area$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/scroll-area.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$ce063b__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:ce063b [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-hook-form/dist/index.esm.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$hookform$2f$resolvers$2f$zod$2f$dist$2f$zod$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@hookform/resolvers/zod/dist/zod.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$4f1cae__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:4f1cae [app-client] (ecmascript) <text/javascript>");
...
function IndicatorSettingsDialog({ isOpen, onOpenChange, settings, onSettingsChange }) {
    ...
    const form = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useForm"])({
        resolver: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$hookform$2f$resolvers$2f$zod$2f$dist$2f$zod$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["zodResolver"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$4f1cae__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["IndicatorSettings"]),
    ...
    const handleReset = ()=>{
        form.reset(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$ce063b__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["defaultIndicatorSettings"]);
    };
...
function Home() {
    ...
    const [indicatorSettings, setIndicatorSettings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$ce063b__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["defaultIndicatorSettings"]);
    ...
    const [wsStatus, setWsStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('connecting');
    const wsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const timeoutIds = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])([]);
    const retryCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    const connectWebSocket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Home.useCallback[connectWebSocket]": ()=>{
            wsRef.current?.close();
            setWsStatus(retryCount.current > 0 ? 'reconnecting' : 'connecting');
            ...
            ws.onmessage = ({
                "Home.useCallback[connectWebSocket]": (event)=>{
                    const data = JSON.parse(event.data);
                    if (data.topic && data.topic.startsWith('publicTrade') && Array.isArray(data.data)) {
                        const newTrades = data.data.map({
                            "Home.useCallback[connectWebSocket].newTrades": (t)=>({
                                    execId: t.i,
                                    price: t.p,
                                    qty: t.v,
                                    side: t.S,
                        ...
                        }["Home.useCallback[connectWebSocket].newTrades"]);
                        setTrades({
                            "Home.useCallback[connectWebSocket]": (prev)=>[
                                    ...newTrades,
                                    ...prev
                                ].slice(0, MAX_VISIBLE_TRADES)
                        }["Home.useCallback[connectWebSocket]"]);
                        const newIds = new Set(newTrades.map({
                            "Home.useCallback[connectWebSocket]": (t)=>t.execId
                        }["Home.useCallback[connectWebSocket]"]));
                        setNewTradeIds(newIds);
                        const highlightTimeout = setTimeout({
                            "Home.useCallback[connectWebSocket].highlightTimeout": ()=>{
                                setNewTradeIds({
                                    "Home.useCallback[connectWebSocket].highlightTimeout": (current)=>{
                                        const updated = new Set(current);
                                        newIds.forEach({
                                            "Home.useCallback[connectWebSocket].highlightTimeout": (id)=>updated.delete(id)
                                        }["Home.useCallback[connectWebSocket].highlightTimeout"]);
                                        return updated;
                                    }
                                }["Home.useCallback[connectWebSocket].highlightTimeout"]);
                            }
                        }["Home.useCallback[connectWebSocket].highlightTimeout"], 1500);
                        timeoutIds.current.push(highlightTimeout);
                    }
                }
            })["Home.useCallback[connectWebSocket]"];
            ws.onerror = ({
                "Home.useCallback[connectWebSocket]": (err)=>{
...
_s(Home, "wUja0GzRt2QcK4ckh/J3zx+P6Ng=");
_c = Home;
var _c;
...
//# sourceMappingURL=src_ba2d8f7b._.js.map