...
class RiskManager:
    ...
    def check_risk_limits(self, current_balance: float, position: dict) -> tuple[bool, str]:
        ...
        position_value = position_size * position.get('mark_price', 0) if position else 0
    ...
    def calculate_position_size(
        ...
        max_position_value = min(
            balance * self.config['max_leverage'],
    ...
    def _calculate_risk_score(self) -> float:
        ...
        daily_loss_score = abs(min(0, self.daily_pnl)) / (self.config['daily_loss_limit'] * self.peak_balance) * 30
