...
class TestPyrmethusBot(unittest.IsolatedAsyncioTestCase):
    ...
    async def asyncSetUp(self):
        ...
        self.MockBybitAPIClass.return_value = self.mock_bybit_client # Make the class return our AsyncMock instance
    ...
    async def test_initial_kline_fetch_success(self):
        ...
        sample_klines = [[str(int(time.time() * 1000) - i*1000), '100', '102', '99', '101', '1000'] for i in range(100)]
