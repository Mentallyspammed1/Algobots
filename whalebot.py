...
class TradingAnalyzer:
    ...
    def analyze_order_book_walls(self, order_book: dict[str, Any]) -> tuple[bool, bool, dict[str, Decimal], dict[str, Decimal]]:
        ...
        bids = [(Decimal(price), Decimal(qty)) for price, qty in order_book['bids'][:self.config["order_book_depth_to_check"]]]
        asks = [(Decimal(price), Decimal(qty)) for price, qty in order_book['asks'][:self.config["order_book_depth_to_check"]]]
        ...
        wall_threshold = avg_qty * Decimal(str(self.config["order_book_wall_threshold_multiplier"]))
