    ...
    def generate_trading_signal(self, current_price: Decimal) -> TradeSignal:
        ...
        for name, weight in self.weights.items():
            ...
            if name == "ema_alignment":
                ...
                pass # Generic indicators, contribute to analysis log but not direct score unless specified
        ...
        signal = None
        if raw_score >= Decimal(str(self.config["signal_score_threshold"])):
            signal = "buy"
        elif raw_score <= -Decimal(str(self.config["signal_score_threshold"])):
            signal = "sell"
        ...
        max_score = sum(self.weights.values()) + self.config.get("order_book_support_confidence_boost", 0) # Simplified max score calculation
