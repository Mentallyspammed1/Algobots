...
class PositionManager:
    ...
    def sync_positions_from_exchange(self):
        ...
        for tracked_pos in self.open_positions:
            is_still_open = any(
                str(ex_pos["positionIdx"]) == str(tracked_pos.get("position_id"))
    ...
    def close_position(
        ...
        order_result = place_market_order(
            self.symbol, side_to_close, qty_to_close, self.logger
        )
        ...
        for position in current_internal_positions:
            ...
            if atr_value > 0:
                ...
                if (
                    ...
                    and profit_since_entry_atr >= self.move_to_breakeven_atr_trigger
                ):
