...
def test_record_trade_win(performance_tracker, mock_logger):
    ...
    expected_pnl = pnl - (position["entry_price"] * position["qty"] * performance_tracker.trading_fee_percent) \
                       - (position["exit_price"] * position["qty"] * performance_tracker.trading_fee_percent)
...
def test_get_summary_with_trades(performance_tracker, mock_logger):
    ...
    win_pnl = (win_position["exit_price"] - win_position["entry_price"]) * win_position["qty"]
    ...
    loss_pnl = (loss_position["entry_price"] - loss_position["exit_price"]) * loss_position["qty"]
    ...
    expected_total_pnl = (win_pnl - (win_position["entry_price"] * win_position["qty"] * performance_tracker.trading_fee_percent) - (win_position["exit_price"] * win_position["qty"] * performance_tracker.trading_fee_percent)) \
                         + (loss_pnl - (loss_position["entry_price"] * loss_position["qty"] * performance_tracker.trading_fee_percent) - (loss_position["exit_price"] * loss_position["qty"] * performance_tracker.trading_fee_percent))
