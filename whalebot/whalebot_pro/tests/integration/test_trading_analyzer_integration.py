...
async def test_generate_trading_signal_hold(
    ...
    trading_analyzer.indicator_values = {
        ...
        "BB_Lower": Decimal("100"),
        "VWAP": Decimal("100"),
        "PSAR_Val": Decimal("100"),
        "PSAR_Dir": 0,
        "ST_Fast_Dir": 0,
        "ST_Slow_Dir": 0,
        "MACD_Line": 0,
        ...
        "PlusDI": 20,
        "MinusDI": 20,
        "Tenkan_Sen": Decimal("100"),
        "Kijun_Sen": Decimal("100"),
        "Senkou_Span_A": Decimal("100"),
        "Senkou_Span_B": Decimal("100"),
        "Chikou_Span": Decimal("100"),
        "OBV": Decimal("0"),
        "OBV_EMA": Decimal("0"),
        "CMF": Decimal("0"),
        ...
        "VWMA": Decimal("100"),
        "Volume_Delta": 0.0,
        "Kaufman_AMA": Decimal("100"),
        "Relative_Volume": 1.0,
        "Market_Structure_Trend": "SIDEWAYS",
        "DEMA": Decimal("100"),
        "Keltner_Upper": Decimal("100"),
        "Keltner_Lower": Decimal("100"),
        "ROC": 0.0,
...
async def test_generate_trading_signal_buy(
    ...
    trading_analyzer.indicator_values = {
        ...
        "PlusDI": 40,
        "MinusDI": 10,
        "Tenkan_Sen": Decimal("105"),
        "Kijun_Sen": Decimal("100"),
        "Senkou_Span_A": Decimal("105"),
        "Senkou_Span_B": Decimal("100"),
        "Chikou_Span": Decimal("105"),
        "OBV": Decimal("100"),
        "OBV_EMA": Decimal("90"),
        "CMF": Decimal("0.5"),
        "Volatility_Index": 0.015,
        "VWMA": Decimal("98"),
        "Volume_Delta": 0.5,
        "Kaufman_AMA": Decimal("99"),
        "Relative_Volume": 2.0,
        "Market_Structure_Trend": "UP",
        "DEMA": Decimal("101"),
        "Keltner_Upper": Decimal("105"),
        "Keltner_Middle": Decimal("100"),
        "Keltner_Lower": Decimal("95"),
        "ROC": -10.0,
    ...
    mock_orderbook_manager.get_depth.return_value = (
        [
            PriceLevel(price=100.0, quantity=100.0, timestamp=1),
            PriceLevel(price=99.0, quantity=50.0, timestamp=1),
        ],
        [
            PriceLevel(price=101.0, quantity=10.0, timestamp=1),
            PriceLevel(price=102.0, quantity=5.0, timestamp=1),
        ],
    )
...
async def test_generate_trading_signal_sell(
    ...
    trading_analyzer.indicator_values = {
        ...
        "PlusDI": 10,
        "MinusDI": 40,
        "Tenkan_Sen": Decimal("95"),
        "Kijun_Sen": Decimal("100"),
        "Senkou_Span_A": Decimal("95"),
        "Senkou_Span_B": Decimal("100"),
        "Chikou_Span": Decimal("95"),
        "OBV": Decimal("90"),
        "OBV_EMA": Decimal("100"),
        "CMF": Decimal("-0.5"),
        "Volatility_Index": 0.015,
        "VWMA": Decimal("102"),
        "Volume_Delta": -0.5,
        "Kaufman_AMA": Decimal("101"),
        "Relative_Volume": 0.5,
        "Market_Structure_Trend": "DOWN",
        "DEMA": Decimal("99"),
        "Keltner_Upper": Decimal("105"),
        "Keltner_Middle": Decimal("100"),
        "Keltner_Lower": Decimal("95"),
    ...
    mock_orderbook_manager.get_depth.return_value = (
        [
            PriceLevel(price=100.0, quantity=10.0, timestamp=1),
            PriceLevel(price=99.0, quantity=5.0, timestamp=1),
        ],
        [
            PriceLevel(price=101.0, quantity=100.0, timestamp=1),
            PriceLevel(price=102.0, quantity=50.0, timestamp=1),
        ],
    )
