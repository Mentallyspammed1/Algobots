...
class PrecisionManager:
    ...
    def round_price(self, symbol: str, price: float | Decimal, rounding_mode=ROUND_DOWN) -> Decimal:
    ...
    def round_quantity(self, symbol: str, quantity: float | Decimal, rounding_mode=ROUND_DOWN) -> Decimal:
