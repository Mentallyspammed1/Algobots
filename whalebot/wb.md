...
This consolidated version merges the best features and enhancements from multiple
iterations of the bot, aiming for improved indicator coverage, signal generation,
