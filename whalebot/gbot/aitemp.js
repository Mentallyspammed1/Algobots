 ...
 * - PERSISTENCE: Built-in JSON trade history tracking.
...
class ConfigManager {
    ...
    static DEFAULTS = Object.freeze({
        ...
        indicators: {
            ...
            weights: {
                ...
                volumeFlow: 1.5, orderFlow: 1.2, divergence: 2.5,
    ...
    static async load() {
        ...
        try {
            ...
            // If file missing or error, save defaults
...
class MarketEngine {
    ...
    calculateWSS(analysis, weights) {
        ...
        const comp = { trend: 0, mom: 0, vol: 0, flow: 0, struct: 0 };
...
class Exchange {
    ...
    getStats() {
        ...
        const losses = this.history.filter(t => new Decimal(t.netPnL).lt(0));
