/**
 * 🌊 WHALEWAVE PRO - TITAN EDITION (Final Optimized with Configurable WSS)
 * ----------------------------------------------------------------------
...
// --- 📐 ADVANCED TA LIBRARY (All functions stable) ---
class TA {
...
console.log(`${reason}! PnL: ${netPnl.gte(0) ? NEON.GREEN(` + ${netPnl.toFixed(2)}`) : NEON.RED(` - ${netPnl.times(-1).toFixed(2)}`)}`);
