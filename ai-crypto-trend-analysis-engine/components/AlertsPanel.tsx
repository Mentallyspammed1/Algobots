    ...
    <div className="bg-gray-800/50 border border-gray-700 p-6 rounded-xl shadow-lg h-full">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 mb-6">
        ...
        <div>
          ...
          <input type="number" id="alert-price" value={price} onChange={e => setPrice(e.target.value)} placeholder="e.g., 65000" className="w-full bg-gray-900 border border-gray-600 rounded-lg p-2 focus:ring-sky-500 focus:border-sky-500 transition" />
        </div>
