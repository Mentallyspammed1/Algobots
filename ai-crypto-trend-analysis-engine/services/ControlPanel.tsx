...
interface ControlPanelProps {
  ...
  onMinConfidenceChange: (c: number) => void;
}
    ...
    <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 p-6 rounded-xl shadow-lg mb-8">
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
        ...
        <div className="flex flex-col">
          ...
          <select id="symbol" value={symbol} onChange={(e) => onSymbolChange(e.target.value)} className="bg-gray-900 border border-gray-600 rounded-lg p-2.5 focus:ring-sky-500 focus:border-sky-500 transition">
        ...
        <div className="flex flex-col">
          ...
          <select id="interval" value={interval} onChange={(e) => onIntervalChange(e.target.value)} className="bg-gray-900 border border-gray-600 rounded-lg p-2.5 focus:ring-sky-500 focus:border-sky-500 transition">
