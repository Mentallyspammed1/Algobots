...
def git_log_summary(num_commits: int = 10):
    ...
    try:
        output = run_git_command(["git", "log", f"-n{num_commits}", "--pretty=format:%h - %an, %ar : %s"])
...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", "--num_commits", type=int, default=10, help="Number of commits to display.")
