...
class Signal:
    ...
    def __init__(self, signal_type: str, strength: float, price: float,
                 timestamp: datetime, reasons: List[str], indicators: Dict[str, Any],
                 symbol: str, strategy: str, confidence: float = 0.0):
        """Initialize signal."""
    ...
    def generate_signals(self, df: pd.DataFrame, symbol: str) -> List[Signal]:
        ...
        try:
            ...
            if (current_price > current_supertrend and
                ...
                strength = min(1.0, abs(current_supertrend - current_chandelier) /
                               current_price * 10)
