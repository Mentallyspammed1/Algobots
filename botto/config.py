...
LEVERAGE = safe_get_float("BYBIT_LEVERAGE", 20.0)
TRADE_QTY = safe_get_float("BYBIT_TRADE_QTY", 1)  # Quantity per trade


# --- Indicator Parameters ---
# RSI
RSI_PERIOD = safe_get_int("RSI_PERIOD", 12)
RSI_OVERBOUGHT = safe_get_float("RSI_OVERBOUGHT", 66.0)
RSI_OVERSOLD = safe_get_float("RSI_OVERSOLD", 33.0)
...
# SuperTrend
SUPER_TREND_PERIOD = safe_get_int("SUPER_TREND_PERIOD", 8)
SUPER_TREND_MULTIPLIER = safe_get_float("SUPER_TREND_MULTIPLIER", 2.2)
...
# --- Bybit Endpoints ---
BYBIT_REST_BASE_URL = (
    "https://api.bybit.com" if not TESTNET else "https://api-testnet.bybit.com"
)
